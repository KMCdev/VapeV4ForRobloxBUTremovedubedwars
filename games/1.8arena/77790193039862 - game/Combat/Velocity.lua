...
-- Entry: games/1.8arena/77790193039862 - game/Combat/Velocity.lua
...
__modules = {
	["games/1.8arena/77790193039862 - game/Combat/Velocity"] = function()
		local Velocity
		local Horizontal
		local Vertical
		local Chance
...
return __require("games/1.8arena/77790193039862 - game/Combat/Velocity")
