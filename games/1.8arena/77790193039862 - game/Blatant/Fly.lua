...
-- Entry: games/1.8arena/77790193039862 - game/Blatant/Fly.lua
...
__modules = {
	["games/1.8arena/77790193039862 - game/Blatant/Fly"] = function()
		local Fly
		local LongJump
		run(function()
			local Keys
...
return __require("games/1.8arena/77790193039862 - game/Blatant/Fly")
