...
-- Entry: games/1.8arena/77790193039862 - game/Blatant/HitBoxes.lua
...
__modules = {
	["games/1.8arena/77790193039862 - game/Blatant/HitBoxes"] = function()
		local HitBoxes
		local Targets
		local TargetPart
		local Expand
...
return __require("games/1.8arena/77790193039862 - game/Blatant/HitBoxes")
