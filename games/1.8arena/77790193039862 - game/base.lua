...
-- Entry: games/1.8arena/77790193039862 - game/base.lua
...
__modules = {
	["games/1.8arena/77790193039862 - game/base"] = function()
...
return __require("games/1.8arena/77790193039862 - game/base")
