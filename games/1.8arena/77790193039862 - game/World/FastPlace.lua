...
-- Entry: games/1.8arena/77790193039862 - game/World/FastPlace.lua
...
__modules = {
	["games/1.8arena/77790193039862 - game/World/FastPlace"] = function()
		local FastPlace
		local Value
		local old
...
return __require("games/1.8arena/77790193039862 - game/World/FastPlace")
