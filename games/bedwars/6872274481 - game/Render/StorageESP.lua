...
-- Entry: games/bedwars/6872274481 - game/Render/StorageESP.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Render/StorageESP"] = function()
		local StorageESP
		local List
		local Background
		local Color = {}
...
return __require("games/bedwars/6872274481 - game/Render/StorageESP")
