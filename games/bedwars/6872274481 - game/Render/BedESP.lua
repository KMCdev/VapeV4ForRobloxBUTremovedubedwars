...
-- Entry: games/bedwars/6872274481 - game/Render/BedESP.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Render/BedESP"] = function()
		local BedESP
		local Reference = {}
...
return __require("games/bedwars/6872274481 - game/Render/BedESP")
