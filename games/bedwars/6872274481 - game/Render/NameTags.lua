...
-- Entry: games/bedwars/6872274481 - game/Render/NameTags.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Render/NameTags"] = function()
		local NameTags
		local Targets
		local Color
		local Background
...
return __require("games/bedwars/6872274481 - game/Render/NameTags")
