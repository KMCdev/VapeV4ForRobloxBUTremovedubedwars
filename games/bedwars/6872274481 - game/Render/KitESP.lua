...
-- Entry: games/bedwars/6872274481 - game/Render/KitESP.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Render/KitESP"] = function()
		local KitESP
		local Background
		local Color = {}
		local Reference = {}
...
return __require("games/bedwars/6872274481 - game/Render/KitESP")
