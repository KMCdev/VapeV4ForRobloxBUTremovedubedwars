...
-- Entry: games/bedwars/6872274481 - game/Utility/StaffDetector.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Utility/StaffDetector"] = function()
		local StaffDetector
		local Mode
		local Clans
		local Party
...
return __require("games/bedwars/6872274481 - game/Utility/StaffDetector")
