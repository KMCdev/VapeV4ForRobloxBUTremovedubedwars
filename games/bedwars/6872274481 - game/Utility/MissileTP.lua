...
-- Entry: games/bedwars/6872274481 - game/Utility/MissileTP.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Utility/MissileTP"] = function()
		local MissileTP
...
return __require("games/bedwars/6872274481 - game/Utility/MissileTP")
