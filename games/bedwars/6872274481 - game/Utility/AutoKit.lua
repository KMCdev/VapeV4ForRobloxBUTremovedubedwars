...
-- Entry: games/bedwars/6872274481 - game/Utility/AutoKit.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Utility/AutoKit"] = function()
		local AutoKit
		local Legit
		local Toggles = {}
...
return __require("games/bedwars/6872274481 - game/Utility/AutoKit")
