...
-- Entry: games/bedwars/6872274481 - game/World/Schematica.lua
...
__modules = {
	["games/bedwars/6872274481 - game/World/Schematica"] = function()
		local Schematica
		local File
		local Mode
		local Transparency
...
return __require("games/bedwars/6872274481 - game/World/Schematica")
