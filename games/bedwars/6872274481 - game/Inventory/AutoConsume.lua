...
-- Entry: games/bedwars/6872274481 - game/Inventory/AutoConsume.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Inventory/AutoConsume"] = function()
		local AutoConsume
		local Health
		local SpeedPotion
		local Apple
...
return __require("games/bedwars/6872274481 - game/Inventory/AutoConsume")
