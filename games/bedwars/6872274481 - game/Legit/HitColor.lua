...
-- Entry: games/bedwars/6872274481 - game/Legit/HitColor.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Legit/HitColor"] = function()
		local HitColor
		local Color
		local done = {}
...
return __require("games/bedwars/6872274481 - game/Legit/HitColor")
