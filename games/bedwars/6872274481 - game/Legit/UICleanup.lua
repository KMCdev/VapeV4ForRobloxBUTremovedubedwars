...
-- Entry: games/bedwars/6872274481 - game/Legit/UICleanup.lua
...
__modules = {
	["games/bedwars/6872274481 - game/Legit/UICleanup"] = function()
		local UICleanup
		local OpenInv
		local KillFeed
		local OldTabList
...
return __require("games/bedwars/6872274481 - game/Legit/UICleanup")
