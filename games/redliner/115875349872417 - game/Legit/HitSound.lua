...
-- Entry: games/redliner/115875349872417 - game/Legit/HitSound.lua
...
__modules = {
	["games/redliner/115875349872417 - game/Legit/HitSound"] = function()
		local HitSound
		local Value
		local Volume
		local PitchShift
...
return __require("games/redliner/115875349872417 - game/Legit/HitSound")
