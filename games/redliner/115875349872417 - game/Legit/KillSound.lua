...
-- Entry: games/redliner/115875349872417 - game/Legit/KillSound.lua
...
__modules = {
	["games/redliner/115875349872417 - game/Legit/KillSound"] = function()
		local KillSound
		local Value
		local Volume
		local PitchShift
...
return __require("games/redliner/115875349872417 - game/Legit/KillSound")
