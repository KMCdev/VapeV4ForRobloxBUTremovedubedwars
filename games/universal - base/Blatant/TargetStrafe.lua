...
-- Entry: games/universal - base/Blatant/TargetStrafe.lua
...
__modules = {
	["games/universal - base/Blatant/TargetStrafe"] = function()
		local TargetStrafe
		local Targets
		local SearchRange
		local StrafeRange
...
return __require("games/universal - base/Blatant/TargetStrafe")
