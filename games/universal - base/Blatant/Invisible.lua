...
-- Entry: games/universal - base/Blatant/Invisible.lua
...
__modules = {
	["games/universal - base/Blatant/Invisible"] = function()
		local Invisible
		local oldcf
		local animtrack
		local proper = true
...
return __require("games/universal - base/Blatant/Invisible")
