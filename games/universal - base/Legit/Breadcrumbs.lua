...
-- Entry: games/universal - base/Legit/Breadcrumbs.lua
...
__modules = {
	["games/universal - base/Legit/Breadcrumbs"] = function()
		local Breadcrumbs
		local Texture
		local Lifetime
		local Thickness
...
return __require("games/universal - base/Legit/Breadcrumbs")
