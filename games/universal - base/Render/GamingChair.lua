...
-- Entry: games/universal - base/Render/GamingChair.lua
...
__modules = {
	["games/universal - base/Render/GamingChair"] = function()
...
return __require("games/universal - base/Render/GamingChair")
