...
-- Entry: games/universal - base/Render/SessionInfo.lua
...
__modules = {
	["games/universal - base/Render/SessionInfo"] = function()
		local SessionInfo
		local FontOption
		local Hide
		local TextSize
...
return __require("games/universal - base/Render/SessionInfo")
