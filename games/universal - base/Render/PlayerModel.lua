...
-- Entry: games/universal - base/Render/PlayerModel.lua
...
__modules = {
	["games/universal - base/Render/PlayerModel"] = function()
		local PlayerModel
		local Scale
		local Local
		local Mesh
...
return __require("games/universal - base/Render/PlayerModel")
