...
-- Entry: games/universal - base/Minigames/MurderMystery.lua
...
__modules = {
	["games/universal - base/Minigames/MurderMystery"] = function()
		local MurderMystery
...
return __require("games/universal - base/Minigames/MurderMystery")
