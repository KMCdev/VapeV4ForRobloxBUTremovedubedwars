...
-- Entry: games/universal - base/Utility/StaffDetector.lua
...
__modules = {
	["games/universal - base/Utility/StaffDetector"] = function()
		local StaffDetector
		local Mode
		local Profile
		local Users
...
return __require("games/universal - base/Utility/StaffDetector")
