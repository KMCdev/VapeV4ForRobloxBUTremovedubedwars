...
-- Entry: games/universal - base/Utility/ChatSpammer.lua
...
__modules = {
	["games/universal - base/Utility/ChatSpammer"] = function()
		local ChatSpammer
		local Lines
		local Mode
		local Delay
...
return __require("games/universal - base/Utility/ChatSpammer")
