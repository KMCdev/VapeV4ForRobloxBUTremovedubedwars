...
-- Entry: games/universal - base/Utility/AnimationPlayer.lua
...
__modules = {
	["games/universal - base/Utility/AnimationPlayer"] = function()
...
return __require("games/universal - base/Utility/AnimationPlayer")
