...
-- Entry: games/universal - base/Combat/AutoClicker.lua
...
__modules = {
	["games/universal - base/Combat/AutoClicker"] = function()
		local AutoClicker
		local Mode
		local CPS
...
return __require("games/universal - base/Combat/AutoClicker")
