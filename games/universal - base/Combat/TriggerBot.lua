...
-- Entry: games/universal - base/Combat/TriggerBot.lua
...
__modules = {
	["games/universal - base/Combat/TriggerBot"] = function()
		local TriggerBot
		local Targets
		local ShootDelay
		local Distance
...
return __require("games/universal - base/Combat/TriggerBot")
