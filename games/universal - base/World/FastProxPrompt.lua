...
-- Entry: games/universal - base/World/FastProxPrompt.lua
...
__modules = {
	["games/universal - base/World/FastProxPrompt"] = function()
...
return __require("games/universal - base/World/FastProxPrompt")
