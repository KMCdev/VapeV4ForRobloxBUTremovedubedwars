...
-- Entry: games/893973440 - flee the facility/Render/ComputerESP.lua
...
__modules = {
	["games/893973440 - flee the facility/Render/ComputerESP"] = function()
		local ComputerESP
		local FillColor
		local OutlineColor
...
return __require("games/893973440 - flee the facility/Render/ComputerESP")
