...
-- Entry: games/893973440 - flee the facility/Blatant/SlowBeast.lua
...
__modules = {
	["games/893973440 - flee the facility/Blatant/SlowBeast"] = function()
		local SlowBeast
...
return __require("games/893973440 - flee the facility/Blatant/SlowBeast")
