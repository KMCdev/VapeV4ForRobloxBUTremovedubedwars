...
-- Entry: games/893973440 - flee the facility/Blatant/RestrainBeast.lua
...
__modules = {
	["games/893973440 - flee the facility/Blatant/RestrainBeast"] = function()
		local RestrainBeast
...
return __require("games/893973440 - flee the facility/Blatant/RestrainBeast")
