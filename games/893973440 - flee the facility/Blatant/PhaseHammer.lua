...
-- Entry: games/893973440 - flee the facility/Blatant/PhaseHammer.lua
...
__modules = {
	["games/893973440 - flee the facility/Blatant/PhaseHammer"] = function()
		local PhaseHammer
		local old
...
return __require("games/893973440 - flee the facility/Blatant/PhaseHammer")
