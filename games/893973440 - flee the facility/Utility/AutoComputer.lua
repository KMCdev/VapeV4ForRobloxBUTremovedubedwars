...
-- Entry: games/893973440 - flee the facility/Utility/AutoComputer.lua
...
__modules = {
	["games/893973440 - flee the facility/Utility/AutoComputer"] = function()
		local AutoComputer
...
return __require("games/893973440 - flee the facility/Utility/AutoComputer")
