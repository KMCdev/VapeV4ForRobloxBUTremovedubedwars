...
-- Entry: games/893973440 - flee the facility/base.lua
...
__modules = {
	["games/893973440 - flee the facility/base"] = function()
...
return __require("games/893973440 - flee the facility/base")
