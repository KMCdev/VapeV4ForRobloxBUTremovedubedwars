...
-- Entry: games/frontlines/5938036553 - game/Render/GrenadeESP.lua
...
__modules = {
	["games/frontlines/5938036553 - game/Render/GrenadeESP"] = function()
		local GrenadeESP
		local Background
		local Color = {}
		local Reference = {}
...
return __require("games/frontlines/5938036553 - game/Render/GrenadeESP")
