...
-- Entry: games/jailbreak/606849621 - main/Blatant/AutoPop.lua
...
__modules = {
	["games/jailbreak/606849621 - main/Blatant/AutoPop"] = function()
		local AutoPop
		local Range
		local TeamCheck
		local delays = {}
...
return __require("games/jailbreak/606849621 - main/Blatant/AutoPop")
