...
-- Entry: games/skywars voxel/8768229691 - skywars game/Minigames/Breaker.lua
...
__modules = {
	["games/skywars voxel/8768229691 - skywars game/Minigames/Breaker"] = function()
		local Breaker
		local Range
		local BreakerPart
		local BreakerUI
...
return __require("games/skywars voxel/8768229691 - skywars game/Minigames/Breaker")
