...
-- Entry: games/skywars voxel/8768229691 - skywars game/Blatant/ProjectileAimbot.lua
...
__modules = {
	["games/skywars voxel/8768229691 - skywars game/Blatant/ProjectileAimbot"] = function()
		local TargetPart
		local FOV
		local old, oldMobile
...
return __require("games/skywars voxel/8768229691 - skywars game/Blatant/ProjectileAimbot")
