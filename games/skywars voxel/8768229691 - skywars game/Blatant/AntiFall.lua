...
-- Entry: games/skywars voxel/8768229691 - skywars game/Blatant/AntiFall.lua
...
__modules = {
	["games/skywars voxel/8768229691 - skywars game/Blatant/AntiFall"] = function()
		local AntiFall
		local Mode
		local Material
		local Color
...
return __require("games/skywars voxel/8768229691 - skywars game/Blatant/AntiFall")
