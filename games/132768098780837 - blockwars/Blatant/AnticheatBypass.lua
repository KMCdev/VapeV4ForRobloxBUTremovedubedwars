...
-- Entry: games/132768098780837 - blockwars/Blatant/AnticheatBypass.lua
...
__modules = {
	["games/132768098780837 - blockwars/Blatant/AnticheatBypass"] = function()
...
return __require("games/132768098780837 - blockwars/Blatant/AnticheatBypass")
