...
-- Entry: games/132768098780837 - blockwars/Blatant/Fly.lua
...
__modules = {
	["games/132768098780837 - blockwars/Blatant/Fly"] = function()
		local Fly
		run(function()
			local Value
			local Keys
...
return __require("games/132768098780837 - blockwars/Blatant/Fly")
