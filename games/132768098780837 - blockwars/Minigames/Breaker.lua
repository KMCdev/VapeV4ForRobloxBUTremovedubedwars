...
-- Entry: games/132768098780837 - blockwars/Minigames/Breaker.lua
...
__modules = {
	["games/132768098780837 - blockwars/Minigames/Breaker"] = function()
		local Breaker
		local Range
		local BreakSpeed
		local UpdateRate
...
return __require("games/132768098780837 - blockwars/Minigames/Breaker")
