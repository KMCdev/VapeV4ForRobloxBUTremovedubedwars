...
-- Entry: games/prison life/135564683255158 - vc servers.lua
...
__modules = {
	["games/prison life/135564683255158 - vc servers"] = function()
...
return __require("games/prison life/135564683255158 - vc servers")
