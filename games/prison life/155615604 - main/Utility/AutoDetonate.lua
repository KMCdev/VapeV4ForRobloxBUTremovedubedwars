...
-- Entry: games/prison life/155615604 - main/Utility/AutoDetonate.lua
...
__modules = {
	["games/prison life/155615604 - main/Utility/AutoDetonate"] = function()
		local AutoDetonate
		local SafeCheck
		local localc4
		local ticks = 0
...
return __require("games/prison life/155615604 - main/Utility/AutoDetonate")
