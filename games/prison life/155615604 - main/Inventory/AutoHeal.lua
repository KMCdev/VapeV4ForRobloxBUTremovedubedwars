...
-- Entry: games/prison life/155615604 - main/Inventory/AutoHeal.lua
...
__modules = {
	["games/prison life/155615604 - main/Inventory/AutoHeal"] = function()
		local AutoHeal
		local healItems = {
			Breakfast = true,
			Lunch = true,
...
return __require("games/prison life/155615604 - main/Inventory/AutoHeal")
