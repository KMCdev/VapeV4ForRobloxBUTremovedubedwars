...
-- Entry: games/prison life/155615604 - main/Blatant/AutoTaser.lua
...
__modules = {
	["games/prison life/155615604 - main/Blatant/AutoTaser"] = function()
		local AutoTaser
		local Range
		local VelocityCheck
		local cooldown = 0
...
return __require("games/prison life/155615604 - main/Blatant/AutoTaser")
