...
-- Entry: games/prison life/155615604 - main/Blatant/AutoArrest.lua
...
__modules = {
	["games/prison life/155615604 - main/Blatant/AutoArrest"] = function()
		local AutoArrest
		local Range
		local HandCheck
		local CooldownBar
...
return __require("games/prison life/155615604 - main/Blatant/AutoArrest")
