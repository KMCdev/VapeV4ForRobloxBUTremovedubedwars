...
-- Entry: games/prison life/155615604 - main/Blatant/VehicleFly.lua
...
__modules = {
	["games/prison life/155615604 - main/Blatant/VehicleFly"] = function()
		local VehicleFly
		local Mode
		local Speed
		local welds = {}
...
return __require("games/prison life/155615604 - main/Blatant/VehicleFly")
