...
-- Entry: games/prison life/155615604 - main/Blatant/AntiInvisible.lua
...
__modules = {
	["games/prison life/155615604 - main/Blatant/AntiInvisible"] = function()
		local AntiInvisible
		local threads = {}
		local whitelist = {
...
return __require("games/prison life/155615604 - main/Blatant/AntiInvisible")
