...
-- Entry: games/prison life/155615604 - main/Legit/HitSound.lua
...
__modules = {
	["games/prison life/155615604 - main/Legit/HitSound"] = function()
		local HitSound
		local Value
		local Volume
		local PitchShift
...
return __require("games/prison life/155615604 - main/Legit/HitSound")
