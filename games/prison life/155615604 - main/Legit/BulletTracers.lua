...
-- Entry: games/prison life/155615604 - main/Legit/BulletTracers.lua
...
__modules = {
	["games/prison life/155615604 - main/Legit/BulletTracers"] = function()
		local BulletTracers
		local Material
		local Color
		local Lifetime
...
return __require("games/prison life/155615604 - main/Legit/BulletTracers")
