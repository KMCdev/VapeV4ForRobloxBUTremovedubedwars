...
-- Entry: games/prison life/155615604 - main/Legit/KillSound.lua
...
__modules = {
	["games/prison life/155615604 - main/Legit/KillSound"] = function()
		local KillSound
		local Value
		local Volume
		local PitchShift
...
return __require("games/prison life/155615604 - main/Legit/KillSound")
