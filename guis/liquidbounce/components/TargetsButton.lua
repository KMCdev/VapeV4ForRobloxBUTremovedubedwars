...
-- Entry: guis/liquidbounce/components/TargetsButton.lua
...
__modules = {
	["guis/liquidbounce/components/TargetsButton"] = function()
...
return __require("guis/liquidbounce/components/TargetsButton")
