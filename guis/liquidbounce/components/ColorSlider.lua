...
-- Entry: guis/liquidbounce/components/ColorSlider.lua
...
__modules = {
	["guis/liquidbounce/components/ColorSlider"] = function()
		local optionapi = {
			Type = 'ColorSlider',
...
return __require("guis/liquidbounce/components/ColorSlider")
