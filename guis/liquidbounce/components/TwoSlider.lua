...
-- Entry: guis/liquidbounce/components/TwoSlider.lua
...
__modules = {
	["guis/liquidbounce/components/TwoSlider"] = function()
		local optionapi = {
			Type = 'TwoSlider',
...
return __require("guis/liquidbounce/components/TwoSlider")
